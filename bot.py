...
MODEL = "deepseek-chat"          # или "deepseek-v4-flash" / "deepseek-v4-pro"
...
async def handle_message(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        await update.message.reply_text("😔 Слишком много запросов или ошибка API. Подожди 10 секунд и попробуй снова.")
